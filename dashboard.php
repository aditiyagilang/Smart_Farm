			...
			if (data) {
				...
				aidataRef.once('value').then((aidataSnapshot) => {
					...
					if (aidata && aidata.y1_pred_plus) {
						...
						document.getElementById('ai1Value').textContent = y1_pred_plus[0];
					}
					if (aidata && aidata.y2_pred_plus) {
						const y2_pred_plus = aidata.y2_pred_plus.slice();
						document.getElementById('ai2Value').textContent = y2_pred_plus[0];
					}
				});
			}
		}
		...
		<div class="xs-pd-20-10 pd-ltr-20">
			<div class="row">
				...
				<div class="col-md-6">
					...
					<p style="text-align: right">Prediction 1: <span id="ai1Value"></span></p>
					<p style="text-align: right">Prediction 2: <span id="ai2Value"></span></p>
						...
						<div class="card-header">
							...
							<div class="progress-container">
								<div class="progress-bar">
									<div class="progress" style="width: <?php echo 94 ?>%;">
									</div>
								</div>
							</div>
				...
				<div class="col-md-6">
					<div class="card card-primary card-outline">
						<div class="card-header">
							...
							<div class="progress-container">
								<div class="progress-bar">
									<div class="progress" style="width: <?php echo $soilPercents[0]; ?>%;"></div>
								</div>
							</div>
						</div>
